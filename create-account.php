...
<body>
    <div class="login-form-section">
        <img data-image src="images/signup-background-image.jpg" width="100%" height="100%" alt="">
        ...
        <div class="login-form">
            <form action="create-account-fun.php" method="post">
                ...
                <div class="form-group">
                    <input type="submit" name="create-accout" value="Login" class="btn btn-primary w-100">
                </div>
            </form>
        </div>
    </div>
