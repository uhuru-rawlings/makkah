	...
	<div class="super_container">
		...
		<div class="intro">
			<div class="container">
				<div class="row">
					<div class="col-lg-5">
						<div class="intro_image"><img width="100%" height="auto" src="images/about-holiday-book.jpg" alt=""></div>
					</div>
		...
		<div class="gpadding add">
			<div class="container">
				<div class="row">
					<div class="col">
						<div class="add_container">
							<div class="add_background" style="background-image:url(images/travel-about-us.jpg)"></div>
							<div class="add_content">
								<h1 class="add_title">Travel The World</h1>
								<div class="add_subtitle">Exceptional travel experiences with Al-Ihsan. Starting From <span>$999</span></div>
								<div class="button add_button">
									<div class="button_bcg"></div><a href="contact.php">Reach Out Now<span></span><span></span><span></span></a>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-6" id="marked_list">
						<div class="section_title"><span class=""><i class="fa-solid fa-bullseye"></i></span> Mission</div>
					...
					<div class="col-sm-6" id="marked_list">
						<div class="section_title"><i class="fa fa-lightbulb" aria-hidden="true"></i> Vision</div>
						<p>
				...
				<div class="row">
					...
					<div class="col-lg-3 milestone_col">
						<div class="milestone text-center">
							<div class="milestone_icon"><i class="iconcolor fa fa-users fa-4x" aria-hidden="true"></i></div>
							<div class="milestone_counter" data-end-value="960+">0</div>
							<div class="milestone_text">Our Clients</div>
						</div>
					</div>
					...
					<div class="col-lg-3 milestone_col">
						<div class="milestone text-center">
							<div class="milestone_icon"><i class="iconcolor fa fa-map-marker fa-4x" aria-hidden="true"></i></div>
					...
					<div class="col-lg-3 milestone_col">
						<div class="milestone text-center">
							<div class="milestone_icon"> <i class="iconcolor fa fa-plane fa-4x" aria-hidden="true"></i></div>
							<div class="milestone_counter" data-end-value="39+">0</div>
							<div class="milestone_text">Plane Trips</div>
						</div>
					</div>
					...
					<div class="col-lg-3 milestone_col">
						<div class="milestone text-center">
							<div class="milestone_icon"><i class="iconcolor fa fa-handshake fa-4x" aria-hidden="true"></i></div>
							<div class="milestone_counter" data-end-value="10+">0</div>
							<div class="milestone_text">Partners</div>
						</div>
					</div>
		...
		<div class="why_choose_us">
			<div class="container">
				<div class="gpadding section_title text-center">Why Choose Us </div>
				...
				<div class="row">
					<div class="col-sm-4">
						Our proven track record speaks for itself. Over the years, we have provided services par excellence that value and empower our clients. Many factors make us your best choice in air travel and accommodation booking. This includes:
							<img class="gpadding" src="images/burj-khalifa.jpg" width="100%" height="auto" alt="" srcset="">
					</div>
					<div class="col-sm-8" id="marked_list">
						<ul>
							<p>
								<span class="list_check"><i class="iconcolor fa-solid fa-check-circle"></i></span>
