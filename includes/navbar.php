<nav>
    <div class="top-nav-social-links">
        <div class="contact-us-details">
            <ul>
                <li><a href="mailto:info@alIhsanumrah.com">info@alIhsanumrah.com</a></li>
        ...
        <div class="flex-logo-section">
            <div class="logo"><img src="images/logo-landscape.png" width="100%" height="100%" alt=""></div>
            <div class="contact-details">
                <div class="phone-ico"><i class="fa-solid fa-phone"></i></div>
                <div class="phone-number-details">
                    <div class="text">Call Now</div>
                    <div class="phoneno"><a href="tel:+254 727 885454"> +254 727 885454</a></div>
                </div>
            </div>
        </div>
        <div class="nav-link-lists" id="nav-link-lists">
            <ul>
            ...
            <div class="call-to-action-button">
                <a href="contact.php"><button class="btn btn-primary">Contact</button></a>
            </div>
        </div>
    </div>
</nav>