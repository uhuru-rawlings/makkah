        ...
        <section class="body-content">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Airline Bookings</li>
                </ol>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $book['From_location']?></td>
                                    <td><?php echo $book['To_location']?></td>
                                    <td><?php echo $book['From_date']?></td>
                                    <td><?php echo $book['Travel_class']?></td>
