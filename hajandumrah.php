...
<body>
    ...
    <div class="haj-and-umrah">
        <div class="container py-4">
            <div class="row">
                <div class="col-sm-6">
                    <img src="images/umra-package.jpg" width="100%" height="100%" alt="" class="">
                </div>
                <div class="col-sm-6">
                    <h2 class="header-text">Hajj & Umrah Services</h2>
                    <p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <p>
                        <a href="umra-services.php"><button class="btn btn-secondary">READ MORE</button></a>
                    </p>
                </div>
                <div class="col-sm-6">
                    <h2 class="header-text">Hajj Services</h2>
                    <p>
                    ...
                    <p>
                        <a href="hajj-services.php"><button class="btn btn-secondary">READ MORE</button></a>
                    </p>
                </div>
            </div>
